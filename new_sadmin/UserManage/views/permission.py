...
def NoPermission(request):
    ...
    return render(request,'UserManage/permission.no.html',kwvars)
...
def AddPermission(request):
    ...
    return render(request,'UserManage/permission.add.html',kwvars)
...
def ListPermission(request):
    ...
    return render(request,'UserManage/permission.list.html',kwvars)
...
def EditPermission(request,ID):
    ...
    return render(request,'UserManage/permission.edit.html',kwvars)
