...
from new_sadmin.common.CommonPaginator import SelfPaginator
...
def LoginUser(request):
    ...
    return render(request,'UserManage/login.html',kwvars)
...
def ListUser(request):
    ...
    return render(request,'UserManage/user.list.html',kwvars)
...
def AddUser(request):
    ...
    return render(request,'UserManage/user.add.html',kwvars)
...
def EditUser(request,ID):
    ...
    return render(request,'UserManage/user.edit.html',kwvars)
...
def ResetPassword(request,ID):
    ...
    return render(request,'UserManage/password.reset.html',kwvars)
