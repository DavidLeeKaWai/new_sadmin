...
def AddRole(request):
    ...
    return render(request,'UserManage/role.add.html',kwvars)
...
def ListRole(request):
    ...
    return render(request,'UserManage/role.list.html',kwvars)
...
def EditRole(request,ID):
    ...
    return render(request,'UserManage/role.edit.html',kwvars)
